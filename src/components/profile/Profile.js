...
class Profile extends Component {
    ...
    componentDidMount() {
        ...
        let profileUrl = "https://s3-us-west-1.amazonaws.com/sanchigoyal.com/resources/profiles/" + profileId + "/profile.json";
        ...
        return(
            <div>
                ...
                <Container>
                    ...
                    <CardGroup
                            title="Project"
                            records={this.state.profile.projects}>
                    </CardGroup>
                    <Skills records={this.state.profile.skills}></Skills>
                </Container>
            </div>
        )
    }
